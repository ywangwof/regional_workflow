...
subroutine read_vcoord(isnative,vcoordi,vcoordo,lev_input,levp1_input,metadata,iret)
  ...
  if (isnative) then 
    ...
    elseif(trim(external_model) == "NAM" .and. lev_input == 60) then
      ...
      vcoordo(:,2) = & 
      (/0,1.0994**-02,2.2004001**-02,3.3054002**-02,4.4144001**-02, 5.5294003**-02, &
        6.6593997**-02,7.8093998**-02,8.9794002**-02,0.101894,0.114294,0.127094,0.140494,&
