...
subroutine read_vcoord(isnative,vcoordi,vcoordo,lev_input,levp1_input,metadata,iret)
  ...
  if (isnative) then 
    ...
    elseif(trim(external_model) == "NAM" .and. lev_input == 60) then
      ...
      1.094331,1.0,0.9083837,0.8263722,0.7521186,0.6852535,0.6254073,0.5703636,0.5190141, &
      0.4695117,0.4222259,0.3764177,0.3317178,0.2884955,0.2460121,0.2042676,0.1630771, &
      0.1221084,8.1287362*10**-2,4.0614128*10**-2,0.0/)*1000.0
