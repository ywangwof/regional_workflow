...
#-----------------------------------------------------------------------
#
WORKDIR_ICBC_CDATE_BCS_WORK="$WORKDIR_ICBC/$CDATE/BCs_work"
mkdir_vrfy -p "$WORKDIR_ICBC_CDATE_BCS_WORK"
cd WORKDIR_ICBC_CDATE_BCS_WORK
...
#-----------------------------------------------------------------------
#
# Build the namelist for chgres_cube and loop for BC generation.
#
#-----------------------------------------------------------------------
#
...
#----------------------------------------
# Move boundary file to ICs_BCs directory 
#----------------------------------------

mv gfs_bndy.nc ../gfs_bndy.tile7.${bchour}.nc
